...
to most OO programmers. This post assumes the reader is more familiar with OO than FP, so we won't
offer a lot more detail as to how one may have come to the above, nor include the boilerplate to
define all of those classes.
...
This was a primer to problem decomposition in FP. It certainly shares a lot of similarities to OOP,
but our focus is on data and transformations rather than objects, relationships and behaviours. You
can view the entire code on [this gist](https://gist.github.com/srazzaque/7be0482c606506a8b860).
...
There's, of course, much more to explore. For instance, how do we talk to databases or work with
a messaging layer? We'll be exploring these in future posts :-)
